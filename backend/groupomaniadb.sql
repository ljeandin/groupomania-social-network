...
CREATE TABLE `likes` (
  ...
  KEY `FK_post_likes_idx` (`post_id`),
  CONSTRAINT `FK_post_likes` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `posts` (
  ...
  `adminApproved` tinyint NOT NULL DEFAULT '0',
...
-- Dump completed on 2021-02-04 14:15:18
